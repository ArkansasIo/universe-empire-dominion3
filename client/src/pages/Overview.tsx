               ...
               <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-4">
                     <div className="bg-slate-50 p-4 rounded border border-slate-200">
                        ...
                        <div className="text-xl font-orbitron text-slate-900">12,800 km <span className="text-xs text-muted-foreground">(189/193 fields)</span></div>
                     ...
                     <div className="bg-slate-50 p-4 rounded border border-slate-200">
                        ...
                        <div className="text-xl font-orbitron text-slate-900">12°C to 48°C</div>
                     </div>
                  </div>
                  ...
                  <div className="space-y-4">
                     <div className="bg-slate-50 p-4 rounded border border-slate-200">
                        ...
                        <div className="text-xl font-orbitron text-slate-900">0 <span className="text-xs text-muted-foreground">/ 0</span></div>
                     </div>
                     ...
                     <div className="bg-slate-50 p-4 rounded border border-slate-200">
                        ...
                        <div className="text-xl font-orbitron text-green-600">100%</div>
                     </div>
                  </div>
               </div>
            </CardContent>
